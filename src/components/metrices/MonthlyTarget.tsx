import { useGetDashboardQuery } from "@/redux/apis/patientsApi";
    ...
    <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
      {isLoading ? (
        ...
        <>
          ...
          <div className="flex items-center justify-center gap-5 px-4 py-3.5 sm:gap-8 sm:py-4">
            <div>
            ...
            <div>
              ...
              <p className="flex items-center justify-center gap-1 text-base font-semibold text-gray-800 dark:text-white/90 sm:text-lg">
                {data?.patients_with_missing_reports}
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
