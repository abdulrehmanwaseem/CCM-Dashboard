      ...
      {isFetching ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {data?.map((gap: PatientGap) => (
            <div
              key={gap.patient_id}
              className="border border-gray-200 rounded-lg p-4 shadow-sm bg-gray-50 dark:bg-white/[0.03] dark:border-gray-800"
            >
              ...
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-white/70 space-y-1">
